...
// attribution required) used as placeholder imagery per partner type until
// a real photo pipeline (see CLAUDE.md "Phase 5: Web CMS") is in place.
...
const priceStandards = {
  ...
  krapao_moo_sap: {
    ...
    min_price: 60, max_price: 90, category: 'food',
  },
  krapao_gai: {
  ...
  krapao_neua: {
    ...
    min_price: 70, max_price: 110, category: 'food',
  },
  krapao_moo_grob: {
  ...
  krapao_talay: {
    ...
    min_price: 90, max_price: 150, category: 'food',
  },
  ...
  neua_kratiem: {
    ...
    min_price: 80, max_price: 130, category: 'food',
  },
  ...
  pad_prik_gaeng_moo: {
    ...
    min_price: 60, max_price: 100, category: 'food',
  },
  pad_prik_gaeng_gai: {
  ...
  pad_prik_gaeng_tua_fak_yao: {
    ...
    min_price: 50, max_price: 80, category: 'food',
  },
  ...
  het_fang_pad_namman_hoy: {
    ...
    min_price: 50, max_price: 90, category: 'food',
  },
  ...
  pad_pak_boong_fai_daeng: {
    ...
    min_price: 40, max_price: 70, category: 'food',
  },
  ...
  pad_priao_wan: {
    ...
    min_price: 70, max_price: 120, category: 'food',
  },
  pad_cha_talay: {
    ...
    min_price: 100, max_price: 160, category: 'food',
  },
  muek_pad_kai_kem: {
  ...
  kai_dao: {
    ...
    min_price: 15, max_price: 30, category: 'food',
  },
  kai_tun_moo_sap: {
  ...
  kai_palo: {
    ...
    min_price: 30, max_price: 60, category: 'food',
  },
  ...
  tom_saep_kraduk_on: {
    ...
    min_price: 80, max_price: 150, category: 'food',
  },
  ...
  yam_wun_sen: {
    ...
    min_price: 60, max_price: 110, category: 'food',
  },
  yam_moo_yo: {
  ...
  plah_goong: {
    ...
    min_price: 120, max_price: 200, category: 'food',
  },
  larb_moo: {
  ...
  suki_haeng_talay: {
    ...
    min_price: 90, max_price: 160, category: 'food',
  },
  suki_haeng_gai: {
