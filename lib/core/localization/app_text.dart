...
const Map<String, Map<String, String>> _appText = {
  ...
  'scanner_instructions_subtitle': {
    'th': 'ถ่ายรูปราคาเพื่อเทียบกับช่วงราคาทั่วไป',
    'en': 'Take a photo of prices to compare with typical ranges',
    'zh': '拍摄价格照片，与一般价格范围进行比较',
    'ko': '가격 사진을 찍어 일반적인 가격대와 비교해 보세요',
    'ru': 'Сфотографируйте цены, чтобы сравнить их с типичным диапазоном',
    'ja': '価格を撮影して、一般的な価格帯と比較しましょう',
  },
  ...
  'scanner_no_text_found': {
    'th': 'ไม่พบข้อความที่อ่านได้ ลองถ่ายให้ใกล้ขึ้นและหลีกเลี่ยงแสงสะท้อน',
    'en': 'No readable text found. Try getting closer and avoid glare.',
    'zh': '未检测到可识别的文字。请靠近一些并避免反光。',
    'ko': '읽을 수 있는 텍스트를 찾지 못했습니다. 더 가까이서 촬영하고 빛 반사를 피해보세요.',
    'ru': 'Текст не распознан. Подойдите ближе и избегайте бликов.',
    'ja': '読み取れるテキストが見つかりません。近づいて反射を避けて撮影してください。',
  },
  'scanner_no_match_found': {
    'th': 'ไม่พบรายการที่ตรงกัน ลองสแกนรายการราคาที่ชัดเจนกว่านี้',
    'en': 'No matching items found. Try scanning a clearer price list.',
    'zh': '未找到匹配的项目。请尝试扫描更清晰的价目表。',
    'ko': '일치하는 항목을 찾지 못했습니다. 더 선명한 가격표를 스캔해 보세요.',
    'ru': 'Совпадений не найдено. Попробуйте отсканировать более чёткий прайс-лист.',
    'ja': '一致する項目が見つかりません。より鮮明な価格表をスキャンしてください。',
  },
  'scanner_scan_again': {
